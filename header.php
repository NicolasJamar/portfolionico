...
<html class="no-js" lang="en">
  <head>
    ...
    <?php wp_head(); //Va appeler les wp_equeue_style ou script dans functions.php ?>

  </head>

  <body <?php body_class(); //pour voir la ligne du dashboard au-dessus qd on visite notre site ?>>
    <header class="row no-max pad main">
      ...
      <nav>
        <h1 class="open"><a class='current' href="<?php bloginfo('url'); ?>"><?php bloginfo('name') ?></a></h1>
          ...
          <?php 
            $defaults = array(
                'container' => false,  //on sort le menu du container
